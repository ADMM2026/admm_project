...
def assign_ids(documents: list[dict], collection) -> list[dict]:
    # Parse all existing numeric IDs to avoid lexicographic sort issues (ATT_9 > ATT_10)
...
def main(args):
    ...
    print(f"Completed. Stored {len(documents)} attractions.")
